...
<html>
    ...
    <body>
        ...
        <div class="docker">
            ...
            <p>
                En el ámbito de la informática, un entorno de trabajo (o workspace en inglés) se refiere al conjunto de recursos, herramientas, configuraciones y tecnologías que se utilizan para realizar tareas específicas, ya sea en el desarrollo de software, la administración de sistemas o cualquier actividad relacionada con la informática.
                <br><br>
                Para esta sección teórica, se va a enseñar a como montar un entorno de trabajo que nos permita realizar las labores de
            </p>
        </div>
    </body>
</html>