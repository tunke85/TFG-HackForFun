<?php
    ...
    $machineName = $conexion->execute_query("SELECT name FROM machines WHERE name = 'users-leaks'")->fetch_assoc();
    $serverId = $conexion->execute_query("SELECT machineid FROM machines WHERE name = 'users-leaks'")->fetch_assoc();
...
<html>
    ...
    <body>
        ...
        <div class="docker">
            ...
            <p>
                <a href="users-leaks/ofensive.pdf">Solución Ofensiva</a> | <a href="users-leaks/defensive.pdf">Solución Defensiva</a>
            </p>
        </div>
        <div id="vpn">
